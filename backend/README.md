...
## Project Structure
    ...
    ├── testapiautoteammemb_58410  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_58410`
...
2. Clone this repo and `cd testapiautoteammemb_58410`
